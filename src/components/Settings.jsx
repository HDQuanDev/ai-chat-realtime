...
const SettingsModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50 transition-opacity duration-300 p-4 overflow-y-auto">
      <div
        ref={modalRef}
        className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-2xl w-full max-w-4xl transition-colors duration-300 my-auto max-h-[90vh] overflow-y-auto"
      >
        ...
        <p className="text-center mt-6 text-xs text-gray-500 dark:text-gray-400">
          ...
          <a
            ...
            target="_blank"
            className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors duration-200 no-underline"
            rel="noreferrer"
          >
            Hứa Đức Quân
          </a>
          ...
          <a
            href="https://github.com/HDQuanDev/ai-chat-realtime"
            target="_blank"
            className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors duration-200 no-underline"
            rel="noreferrer"
          >
      ...
      <div className="transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 p-2 rounded-lg">
        <div className="mt-4 bg-gray-100 dark:bg-gray-700 p-4 rounded-lg text-sm text-gray-800 dark:text-white transition-colors duration-200">
          <p>
            ...
            Bạn có thể xem bảng xếp hạng của các mô hình tại{" "}
            <a
      ...
      <>
        ...
        <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg text-sm text-gray-800 dark:text-white transition-colors duration-200 mt-4">
          <p>
            ...
            ID Chat được sử dụng để xác định người dùng và lưu trữ dữ liệu chat.
            Bạn có thể sử dụng ID này để đồng bộ dữ liệu chat giữa các thiết bị.
            <br />
            Để cập nhật ID Chat hãy nhấn vào nút "Cập nhật" và nhập ID Chat được
            cung cấp từ thiết bị muốn đồng bộ dữ liệu chat.
          </p>
        </div>
    ...
    return (
      <div className="transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 p-2 rounded-lg">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-gray-600 dark:text-gray-300">
          ...
          <li>🎉 Open Source Code: Clear Code, Chuyển đổi các file .JS qua .JSX</li>
          <li>🎉 Cải thiện: Hiệu suất và tối ưu hoá giao diện người dùng</li>
        </ul>
        <hr className="my-4" />
        <h2 className="text-lg md:text-xl font-semibold text-gray-800 dark:text-white mb-4">
          Nhật Ký Thay Đổi Phiên Bản 1.4.5
        </h2>
        <ul className="list-disc list-inside space-y-2 text-sm text-gray-600 dark:text-gray-300">
          <li>
            🎉 Sửa lỗi: Modal "Đang kết nối đến máy chủ..." luôn hiển thị khi
            EventSource kết nối lại
          </li>
          <li>
            🎉 Cập nhật: Nút dừng phản hồi được tích hợp trong phần InputBox
          </li>
          <li>
            🎉 Cập nhật: Thêm lưu tin nhắn khi người dùng nhấn Dừng phản hồi
          </li>
          <li>🎉 Cải thiện: Hiệu suất và tối ưu hoá giao diện người dùng</li>
        </ul>
        <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg text-sm text-gray-800 dark:text-white transition-colors duration-200 mt-4">
          <p>
            ...
            Nếu bạn gặp bất kỳ vấn đề nào khi sử dụng hoặc góp ý để cải thiện
            trang web, vui lòng{" "}
            <a
              href="https://www.facebook.com/quancp72h"
              target="_blank"
